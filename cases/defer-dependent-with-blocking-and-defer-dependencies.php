...
add_action( 'wp_enqueue_scripts', static function () {
	enqueue_test_script( 'blocking-dependency-with-defer-following-dependency', 'blocking', [] );
	enqueue_test_script( 'defer-dependency-with-blocking-preceding-dependency', 'defer', [] );
	enqueue_test_script( 'defer-dependent-of-blocking-and-defer-dependencies', 'defer', [ 'blocking-dependency-with-defer-following-dependency', 'defer-dependency-with-blocking-preceding-dependency' ] );
} );
