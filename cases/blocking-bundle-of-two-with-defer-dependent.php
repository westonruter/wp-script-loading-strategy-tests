...
add_action( 'wp_enqueue_scripts', static function () {
	...
	wp_register_script( 'blocking-bundle-of-two', false, [ 'blocking-bundle-member-one', 'blocking-bundle-member-two' ], null );
	enqueue_test_script_with_inline_scripts( 'blocking-bundle-member-one', 'blocking', [] );
	enqueue_test_script_with_inline_scripts( 'blocking-bundle-member-two', 'blocking', [] );
